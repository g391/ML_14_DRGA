...
class Dataset(object):
    def __init__(self, dataset, logger):
        ...
        with open(dataset + '/train_full.txt', 'r', encoding='utf-8') as f:
            self.origin['train'] = json.load(f)

        with open(dataset + '/dev_full.txt', 'r', encoding='utf-8') as f:
...
class Parser(object):
    def getParser(self):
        ...
        parser.add_argument('--name', type=str, default='DRAF-self-attention')
        parser.add_argument('--log', type=str, default='DRAF-SUBJ.log')
        parser.add_argument('--smalldata', type=int, default=0, choices=[0, 1])
        #parser.add_argument('--seed', type=int, default=int(1000 * time.time()))
        parser.add_argument('--seed', type=int, default=int(100))
        parser.add_argument('--dataset', type=str, default='E:/Master/Term1/DRGA/TrainData/SUBJ/')
        ...
        parser.add_argument('--word_vector', type=str, default='E:/Master/Term1/DRGA/glove.6B/glove.6B.100d.txt')
