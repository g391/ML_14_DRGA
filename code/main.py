...
import random
import sys, os
from helpers import Parser, Dataset
from engines import PolicyNet, SelfAttentionNet
import time
import logging
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        # Actor-Critic model -> mô hình tác nhân và nhà phê bình
        # Thực hiện trên selfAttention
